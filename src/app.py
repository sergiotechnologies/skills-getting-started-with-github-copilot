...
activities = {
    ...
    "Drama Club": {
        "description": "Practice acting, stagecraft, and perform plays",
    ...
    "Science Club": {
        "description": "Explore experiments and scientific concepts together",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
...
def signup_for_activity(activity_name: str, email: str):
    ...
    # Validate activity has availability
